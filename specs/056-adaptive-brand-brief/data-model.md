...
Gate 1 binds exact production source and proof evidence. The private Gate 2 packet must match the current canonical source digest in the brand's continuity record and approval ledger; syntactically valid but stale or invented digests are rejected. Wide, stacked, and social preview roles need distinct paths and verified content hashes. Gate 2 binds reviewed provisional derivatives and authorizes final fundamentals. Source change returns to Gate 1 and invalidates affected Gate 2 evidence; derivative or social-copy change returns to Gate 2. Pending or rejected state carries no approval evidence and cannot publish.
