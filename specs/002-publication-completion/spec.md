...
This slice implements issues #17 through #36:
...
19. Deferred Pillow imports so the core-tier QC entry point can record named skips.
...
- Unit tests cover capability parsing, offline fonts, core raster and QC skips without Pillow, production image-backed generation without Pillow, tier-downgrade cleanup, stale image and PDF QC cleanup, fatal full-tier PDF/page failures, independent ICO capability, Windows flags, form semantics, and CTA semantics.
