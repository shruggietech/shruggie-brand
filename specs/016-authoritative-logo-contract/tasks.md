...
- [ ] T036 Push `codex/016-authoritative-logo-contract`, publish the official issue-closing PR, and record the URL in `specs/016-authoritative-logo-contract/evidence.md`
