...
2. Resolve all eight interface cues for dark and light themes from the canon role model plus any approved brand overrides. Return exact source reference, hex, role meaning, non-color cue, best black/white foreground, measured foreground ratio, theme surface, and measured surface ratio.
