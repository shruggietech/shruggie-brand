...
Post-merge review findings are tracked separately in [#17 through #36](https://github.com/shruggietech/shruggie-brand/issues?q=is%3Aissue%20milestone%3A%2A). They are release blockers where linked from the phase issues.
