...
Gate 2 proposed these exact generated public surfaces: `showcase-card`, `brand-landing-page`, `guideline-topics`, `downloads`, `registry-endpoints`, `public-metadata`, `structured-data`, and `social-preview`. No source repository evidence, historical S012 file, raw approval ledger, or private review packet will be published.
...
Approved by the identity owner on 2026-09-07 after the product-language correction. The decision is bound to derivative provenance SHA-256 `f99e01a666f9242457742467aeeebd308aae37f8411f32fc52186e2c3f1516c4`, the corrected slogan and description, and these exact surfaces: `showcase-card`, `brand-landing-page`, `guideline-topics`, `downloads`, `registry-endpoints`, `public-metadata`, `structured-data`, and `social-preview`. Publication of the raw source inventory, historical evidence, approval packet, or approval ledger remains unauthorized.

## Final Publication and Validation

After Gate 2 approval, site preparation produced six public kits and nine reference documents. ESO Weave appears through exactly the eight approved surface classes. Publication revalidates `logos/provenance.json` against the approved derivative-provenance hash, and negative regression tests prove that a stale hash or incomplete surface approval suppresses the public projection.
