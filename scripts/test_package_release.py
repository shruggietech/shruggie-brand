...
class PackageReleaseTests(unittest.TestCase):
    ...
    def make_brand_source(self, root: Path) -> Path:
        ...
        consumer = {
            ...
            "versions": {"brand_version": "1.0.0", "canon_version": "1.2.1", "interface_canon_version": "1.0.0", "component_recipe_version": "1.0.0", "web_react_adapter_version": "1.0.0", "compiler_version": "1.2.1"},
            "version_semantics": {
