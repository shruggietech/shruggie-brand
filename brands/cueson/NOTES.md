...
- Gate 1 approval binds `cueframe-r1` geometry SHA-256 `779a7c79ec00a6b62b83468101f6ec6606804833d8c1fbd0b77b5d4baa795a49` and the `cue-teal-r1` palette SHA-256 `15bb46c278449a9b7dbd65238bcd5566abaaf4dcf60c4cfc56bb7a7ecc7c7be2`. Use these exact hashes to detect source drift.
...
- Consumer installation uses `consumer-handoff.json`: verify every source and artifact hash, copy only declared destinations, and preserve license notices. This kit does not itself activate `cueson.io` or change a consumer repository.
