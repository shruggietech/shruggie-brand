...
- Added hash-bound Gate 1 and Gate 2 approval contracts, deterministic source-inventory validation, derivative-bound public projection, and required vendor-boundary propagation for independent third-party identities.
