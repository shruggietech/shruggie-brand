...
from interface_contract import emit_consumer_contract
...
def main():
    ...
    with open(os.path.join(HERE, "..", "references", "01-canon.json"), encoding="utf-8") as source:
        canon = json.load(source)
