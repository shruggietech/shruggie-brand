...
FONTS_TS = '''// GENERATED by shruggie-brandbuilder. Canon rank 2 permits Next.js projects
// to use next/font/google, which can fetch font files at build time. Exported brand kits
// bundle the canonical font bytes separately for deterministic documents and assets.
