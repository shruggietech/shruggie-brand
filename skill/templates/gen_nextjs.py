...
def emit_font_item(brand):
    return {
        ...
        "docs": ("The registry:font schema currently configures Google Fonts. "
                 "For offline and deterministic builds, use the bundled files through "
                 "nextjs/fonts.ts instead.")
    }

FONTS_TS = '''// GENERATED by shruggie-brandbuilder. Keep this file in nextjs/ and the
...
export const GeistMono = localFont({
  src: "../fonts/woff2/GeistMono-Regular.woff2",
  weight: "400",
